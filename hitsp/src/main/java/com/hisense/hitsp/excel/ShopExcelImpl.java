...
import com.hisense.hitsp.model.ExcelTemplateType;
 ...
 */
@Component
public class ShopExcelImpl implements Excel {
        ...
        try {
            ...
            for (int r = 1; r < rowCount; r++) {
                ...
                for (int i = 0; i < cloumNameList.size(); i++) {
                    if (StringUtils.isNotEmpty(String.valueOf(cloumNameList.get(i)))) {
